...
The [https://dl.acm.org/doi/10.1145/3725281](paper) Figures 4, 5, 6 and 7 can be reproduced using the following commands:

Figure 4(a): 

	go run main.go --query=hamil --minNodes=2 --maxNodes=20 --inc=1 --start=0.1 --end=0.1 --user=$Neo4jUsername --pwd=$Neo4jPassword

Figure 4(b): 

	go run main.go --query=hamil --minNodes=2 --maxNodes=20 --inc=1 --start=0.3 --end=0.3 --user=$Neo4jUsername --pwd=$Neo4jPassword

Figure 4(c): 

	go run main.go --query=hamil --minNodes=2 --maxNodes=20 --inc=1 --start=0.8 --end=0.8 --user=$Neo4jUsername --pwd=$Neo4jPassword

Figure 5(a): 

	go run main.go --query=SubsetSum --doubleLine --minNodes=2 --maxNodes=30 --inc=1 --user=$Neo4jUsername --pwd=$Neo4jPassword

Figure 5(b): 

	go run main.go --query=SubsetSum --doubleLine --minNodes=2 --maxNodes=30 --inc=1 --postgres --dbName=$postgresDBName --user=postgres --pwd=$PostgresPassword

Figure 5(c): 

	go run main.go --query=SubsetSum --doubleLine --minNodes=2 --maxNodes=30 --inc=1 --duckDB

Figure 6(a): 

	go run main.go --query=AStarBAStar --labeled --minNodes=2 --maxNodes=20 --inc=1 --start=0.1 --end=0.1 --postgres --dbName=$postgresDBName --user=postgres --pwd=$PostgresPassword

and 

	go run main.go --query=AStarBAStar --labeled --minNodes=2 --maxNodes=20 --inc=1 --start=0.1 --end=0.1 --duckDB

Figure 6(b): 

	go run main.go --query=AStarBAStar --labeled --minNodes=2 --maxNodes=20 --inc=1 --start=0.3 --end=0.3 --postgres --dbName=$postgresDBName --user=postgres --pwd=$PostgresPassword

and 

	go run main.go --query=AStarBAStar --labeled --minNodes=2 --maxNodes=20 --inc=1 --start=0.3 --end=0.3 --duckDB

Figure 6(c): 

	go run main.go --query=AStarBAStar --labeled --minNodes=2 --maxNodes=20 --inc=1 --start=0.8 --end=0.8 --postgres --dbName=$postgresDBName --user=postgres --pwd=$PostgresPassword

and 

	go run main.go --query=AStarBAStar --labeled --minNodes=2 --maxNodes=20 --inc=1 --start=0.8 --end=0.8 --duckDB

Figure 7(a): 

	go run main.go --query=hamil --minNodes=2 --maxNodes=20 --inc=1 --start=0.1 --end=0.1 --postgres --dbName=$postgresDBName --user=postgres --pwd=$PostgresPassword

and 

	go run main.go --query=hamil --minNodes=2 --maxNodes=20 --inc=1 --start=0.1 --end=0.1 --duckDB

Figure 7(b): 

	go run main.go --query=hamil --minNodes=2 --maxNodes=20 --inc=1 --start=0.3 --end=0.3 --postgres --dbName=$postgresDBName --user=postgres --pwd=$PostgresPassword

and 

	go run main.go --query=hamil --minNodes=2 --maxNodes=20 --inc=1 --start=0.3 --end=0.3 --duckDB

Figure 7(c): 

	go run main.go --query=hamil --minNodes=2 --maxNodes=20 --inc=1 --start=0.8 --end=0.8 --postgres --dbName=$postgresDBName --user=postgres --pwd=$PostgresPassword

and 

	go run main.go --query=hamil --minNodes=2 --maxNodes=20 --inc=1 --start=0.8 --end=0.8 --duckDB
